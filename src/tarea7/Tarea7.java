...
public final class Tarea7
{
        ...
        ExportException
    {
        ...
        //codigo para iterar
        Graph<String, DefaultEdge> stringGraph2 = createStringGraph();
        //System.out.println("prueba "+stringGraph.getType());
        
        for(DefaultEdge e : stringGraph2.edgeSet()){
            System.out.println(String.format("El vertice %s esta unido con el %s",stringGraph2.getEdgeTarget(e), stringGraph2.getEdgeSource(e)));
        }
